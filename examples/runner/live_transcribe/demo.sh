#!/usr/bin/env bash
# SDK live demo helper: start live-transcribe and print data-channel records.
...
JOB_FILE=$(mktemp -t live_transcribe_demo.XXXXXX.job.json)
...
echo "Starting live-transcribe via SDK..."
...
echo
echo "Listening for transcript records. Publish audio/video to publish_url with an SDK media publisher."
